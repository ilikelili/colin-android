package com.windo.framework.event.util;
...
import com.windo.framework.event.EventBus;
        ...
        while (true) {
            ...
            if (resId != null) {
                ...
                if (depthToGo <= 0 || throwableToCheck == throwable || throwableToCheck == null) {
                    PalLog.d(EventBus.TAG, "No specific message ressource ID found for " + throwable);
